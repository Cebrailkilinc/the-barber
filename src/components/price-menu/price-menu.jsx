        ...
        <div className='bg-[#292929] py-10' >
            <div className='max-w-[1280px] mx-auto' >
                <div className='text-white flex flex-col gap-8 items-center ' >
                    ...
                    <h1 className='text-[30px]' >Our <span className='text-[#bba88a]' >Price Menu</span></h1>
                ...
                <div className='flex items-center justify-between mt-10' >
                    <div className='flex flex-col gap-10 items-center justify-center p-10 bg-[#2c2c2c] rounded-lg'  >
                        ...
                        <div className='flex items-start justify-between gap-10 ' > 
                            <div className='text-white' >
                                <h1 className='text-[12px] font-semibold'>Chriss Haircut</h1>
                                <h1 className='text-[11px]' >Chriss Haircut Chriss Haircut Chriss Haircut</h1>
                            </div>                            
                            <h1 className='text-[#c5a36e]' >$123</h1>
                        </div>
                        <div className='flex items-start justify-between gap-10 ' > 
                            <div className='text-white' >
                                <h1 className='text-[12px] font-semibold'>Chriss Haircut</h1>
                    ...
                    <div className='flex flex-col gap-10 items-center justify-center p-10 bg-[#c5a36e] rounded-lg'  >
                        ...
                        <div className='flex items-start justify-between gap-10 ' > 
                            ...
                            <h1 className='text-[#292929]' >$123</h1>
                        </div>
                        <div className='flex items-start justify-between gap-10 ' > 
                            <div className='text-white' >
                                <h1 className='text-[12px] font-semibold'>Chriss Haircut</h1>
